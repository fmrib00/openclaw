...
CMD ["node", "openclaw.mjs", "gateway", "--allow-unconfigured", "--bind", "lan", "--gateway.controlUi.dangerouslyAllowHostHeaderOriginFallback", "true", "--gateway.controlUi.allowedOrigins", "https://openclaw-production-0c41.up.railway.app"]
